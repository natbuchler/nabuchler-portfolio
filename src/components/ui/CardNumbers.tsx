...
export function CardNumbers({ number, label }: CardNumbersProps) {
  return (
    <div className="bg-[rgba(255,255,255,0.35)] backdrop-blur-sm rounded-2xl p-6 text-center w-[208px]">
      <div className="font-playfair font-bold text-[64px] leading-[1.2] text-[#421d13] mb-4">
        {number}
      </div>
      <div className="font-roboto-flex text-[18px] leading-[1.5] text-[#6b6763] tracking-[0.36px]">
        {label}
      </div>
    </div>
  );
